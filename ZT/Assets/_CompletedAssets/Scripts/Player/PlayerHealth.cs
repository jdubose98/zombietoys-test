...
namespace CompleteProject
{
    ...
    {
        public int startingHealth = 100;                            // Amount of health at start
        public int currentHealth;                                   // Current HP
        public Slider healthSlider;                                 // UI health bar
        public Image damageImage;                                   // Reference to the image
        public AudioClip deathClip;                                 // Sound to play
        public float flashSpeed = 5f;                               // The speed the damageImage will fade at.
        public Color flashColour = new Color(1f, 0f, 0f, 0.1f);     // The colour the damageImage is set to, to flash.
		public float timeFromLastHit = Time.time;					// Captures the time
		public int regenTime = 5;									// how long it takes to start healing
